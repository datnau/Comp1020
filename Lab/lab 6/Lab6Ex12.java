public class Lab6Ex12{
  ...
  public static void printListBackwards(int[] array){
    printArrayBackwardsRecursively(array,array.length-1);
  }

  public static void printArrayBackwardsRecursively(int[] array, int pos){
    if(pos == 0){
      System.out.print(array[pos]);
    }else{
      System.out.print(array[pos] + " ");
      printArrayBackwardsRecursively(array, pos - 1);
    }
